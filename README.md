...
---
## HOW TO POSE THE CHARACTER:

1. Enter Object Mode.
2. Select the bottom 2 black circles.
...
1. Enter Object Mode.
2. Click on the torso of the character.
3. Go to the Material Tab on the bottom right of your screen.
4. Select the Fur Material at the top of the tab.
...
---
### READ ME
**ExpressiveStaticIKRig**
by Patchwork Studios
...
designed to support expressive IK-based facial and body animation setups.

You are free to:
- Use this rig in personal or commercial projects
- Modify or adapt it for your own workflows
- Distribute or sell products including it

Requirements:
- Keep the included **MIT License** file and copyright notice
- Credit **Patchwork Studios** when appropriate (linking to https://discord.gg/staticvr)

This asset is provided “as is”, without warranty or support guarantee.
